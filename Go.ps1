...
# download CyberAuditLiteFD and CyberFunctions sources
try {
...
Write-Host "We will continue to the CyberAuditLiteFD script" -ForegroundColor Green
Set-ExecutionPolicy Unrestricted
$ScriptToRun = "$BasePath\CyberAuditLiteFD.ps1"
&$ScriptToRun
